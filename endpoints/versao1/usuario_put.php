...
function grupospet_usuario_put($request) {
...
function registrar_grupospet_usuario_put() {
  register_rest_route('grupospet', '/usuario', array(
    array(
      'methods' => WP_REST_Server::EDITABLE,
      'callback' => 'grupospet_usuario_put',
    ),
  ));
}

add_action('rest_api_init', 'registrar_grupospet_usuario_put');