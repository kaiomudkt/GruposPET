<?php
function grupospet_usuario_post($request) {
...
function registrar_grupospet_usuario_post() {
  register_rest_route('grupospet', '/usuario', array(
    array(
      'methods' => WP_REST_Server::CREATABLE,//criacao
      'callback' => 'grupospet_usuario_post',
    ),
  ));
}

add_action('rest_api_init', 'registrar_grupospet_usuario_post');