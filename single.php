...
<?php get_template_part('breadcrumbs'); ?>
    ...
    if (have_posts()):
        ...
        <div id="<?php echo get_the_id(); ?>" <?php post_class('clearfix'); ?> >
            ...
            <!-- MOSTRA METADAODO DO POST, NO CASO, QUAL PET FEZ O POST -->
            <div>
                <?php 
                    $pet_responsavel = esc_attr( get_post_meta( get_the_ID(), 'pet_responsavel', true));
                    echo $pet_responsavel;
                ?>
            </div>
