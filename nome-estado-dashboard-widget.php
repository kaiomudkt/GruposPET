...
function callback_form_nome_estado() {  
    ...
    <p class="meta-options campos">
        <label for="estado">Nome do seu estado/UF (Unidade Federativa).
                <br> Este nome tem que ser idêntico ao nome que está na lista de estados do site Nacional, pois baseado neste nome, que será listado os PETs deste estado quando for criar um novo usário. Ou seja, tenha cuidado.
